...
var HistoryListViewM = React.createClass({
    ...
    renderListView: function() {
        return (
            <View style={styles.container}>
                <View style={{marginTop:0, height:0.5, width:width, backgroundColor: '#d0d0d0'}}></View>
                       ...
                       justifyContent:"center"
                        ...
                        <View style={[{
                         ...
                         padding:10
                            ...
                            <Text style={{color:'#666666',  fontSize:16}}>{strings.删除失败请重试}</Text>
                        </View>
                    </View>
                ):(
                    <View>
                ...
                <View style={{marginBottom: 0, height:this.state.height, backgroundColor:'#f8f8f8'}}>
                    ...
                    <View style={{flexDirection:'row', flex:1}}>
                        <TouchableWithoutFeedback style={{flex:2}} underlayColor='#838383' onPress={
                            ()=>{
    ...
    _deleteBPData(arr){
        ...
        if(deleteArr.length>0){
            ...
            deleteBPData(bodyDic, (isSuccess, responseData, errorStatus)=>{
                    ihealth.log('HistoryListViewM--deleteBPData', 'isSuccess:'+isSuccess+'  responseData:'+JSON.stringify(responseData)+'  errorStatus:'+errorStatus);
                    if (isSuccess) {
...
var route = {
    key: 'HistoryListViewM',
    title: strings.MothersBloodPressure,
    component: HistoryListViewM,
