...
class PluginApp extends React.Component {
  ...
  refreshNavigatorUI_Edit(route, navigator, index, navState){
      return (
          <View style={{left:0, width:60+15*2, height:APPBAR_HEIGHT, justifyContent:'center', alignItems:'center'}}>

            <Text key='edit' style={{left:0, width:60+15*2, height:APPBAR_HEIGHT, color:'#FF6633', fontSize:18, paddingLeft:10, paddingTop:10}}
                  onPress={() => {
