...
class PrivacyAgreement extends Component {
        ...
        return (
            <View style={styles.containerAll}>
                ...
                <View style={styles.containerMenu}>
                    ...
                    <Text style={{marginTop:45, height: 45, width: width, backgroundColor: '#ffffff',fontSize: 18,color: '#FA5223',lineHeight:35,textAlign:'center',alignItems:'center'}} onPress={this._click}> {strings.RevokeTheTermsOfUseAndPrivacyPolicyAuthorization}
                    </Text>
                </View>
    ...
    _createMenuRowA(component){
      ...
      _click(){
        ...
        // comp = MHPluginSDK.openDeleteDeviceWithCustomMessage('撤销授权后，设备会与您当前登陆的账号解除绑定并清除该设备之前存储在服务端的数据；物理设备中存储的数据需要您进行人工本地物理重置后清除，若设备支持，您可以直接在设备上进行重置或参照\"隐私政策\"中的撤销授权进行重置，上述数据撤销后均不可恢复，若要重新使用设备，需要您再次进行绑定并且重新授权',(result)=>{
        //   if(result !="ok")
        //   {
        //     var saveAuth = {};
        //     saveAuth.ifAgree = 0;
